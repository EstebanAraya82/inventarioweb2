...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-12-2024 a las 03:51:54
...
CREATE TABLE `activo` (
  ...
  `activo_estado` enum('Activo','Desuso','Dañado','En transito','En servicio técnico','En garantía','Baja') NOT NULL,
...
INSERT INTO `activo` (`activo_id`, `activo_codigo`, `activo_marca`, `activo_modelo`, `activo_serial`, `categoria_id`, `piso_id`, `posicion_id`, `area_id`, `sector_id`, `activo_estado`, `fecha_ingreso`) VALUES
(1, '11163', 'ViewSonic', 'VG2233Smh', 'TBX153431018', 2, 1, 1, 1, 1, 'Activo', '0000-00-00');
...
(1, 'Esteban', 'Araya', 'arayapalma.5', 'esteban.araya@teleperformance.com', 'Ma170311*', 1, 1, 'Habilitado'),
