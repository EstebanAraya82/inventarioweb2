		...
		<form action="./php/usuario_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off">
			...
			<div class="columns">
				<div class="column">
					<div class="control">
						<label>Nombres</label>
						<input class="input" type="text" name="usuario_nombre" placeholder="Ingrese nombres" 
				...
				<div class="column">
					<div class="control">
						...
						<input class="input" type="text" name="usuario_apellido" placeholder="Ingrese apellidos" 
						pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,50}" maxlength="50" 
			...
			<div class="columns">
				<div class="column">
					<div class="control">
						<label>Usuario</label>
						<input class="input" type="text" name="usuario_usuario" placeholder="Ingrese usuario" 
						pattern="[a-zA-Z0-9@.]{4,50}" maxlength="50" 
