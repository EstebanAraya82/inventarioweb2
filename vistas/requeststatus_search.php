...
<div class="container pb-6 pt-6">
    ...
    <div class="columns">
        <div class="column">
            <form action="" method="POST" autocomplete="off" >
                <input type="hidden" name="modulo_buscador" value="estadosolicitud">   
    ...
    <div class="columns">
        <div class="column">
            <form class="has-text-centered mt-6 mb-6" action="" method="POST" autocomplete="off" >
                <input type="hidden" name="modulo_buscador" value="estadosolicitud"> 
                <input type="hidden" name="eliminar_buscador" value="estadosolicitud">
    ...
    <?php
          if(!isset($_GET['page'])){
            ...
            $url="index.php?vista=statusrequest_search&page="; 
            $registros=10;
