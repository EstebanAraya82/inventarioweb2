<div class="container is-fluid mb-6">
    <h1 class="title">Solicitudes de baja de activos</h1>
    <h2 class="subtitle">Buscar solicitud de baja</h2>
</div>
...
<div class="container pb-6 pt-6">
    ...
    if (!isset($_SESSION['busqueda_bajaactivo']) && empty($_SESSION['busqueda_bajaactivo'])) {
    ?>
        <div class="columns">
            <div class="column">
    ...
    <?php
        ...
        $registros = 5;
        $busqueda = $_SESSION['busqueda_bajaactivo'];
