...
<div class="container pb-6 pt-6">
    <?php
        ...
        if(!isset($_SESSION['busqueda_estadoactivo']) && empty($_SESSION['busqueda_estadoactivo'])){
    ?>
    <div class="columns">
        <div class="column">
    ...
    <div class="columns">
        <div class="column">
            <form class="has-text-centered mt-6 mb-6" action="" method="POST" autocomplete="off" >
                ...
                <p>Estas buscando <strong>“<?php echo $_SESSION['busqueda_estadoactivo']; ?>”</strong></p>
                <br>
    ...
    <?php
          if(!isset($_GET['page'])){
            ...
            $registros=10;
            $busqueda=$_SESSION['busqueda_estadoactivo']; 
